							...
							<table id="ts_tiny_tinymce_table_icon" class="ts_tiny_form ts_tiny_table ts_tiny_tinymce_table_icon" cellspacing="0" style="">
								<?php
									...
									$output .= '<tr>';
										...
										$output .= '<td>';
											$output .= '<div id="ts-tiny-tinymce-importer" class="toggle toggle-light" data-checkbox="ts-tiny-tinymce-importer-check" style="width: 80px; height: 18px;" data-on="' . __( "Show", "ts_visual_composer_extend" ) . '" data-off="' . __( "Hide", "ts_visual_composer_extend" ) . '">';
												$output .= '<div class="toggle-slide">';
													$output .= '<div class="toggle-inner">';
														$output .= '<div class="toggle-on" style="height: 18px;"">' . __( "Show", "ts_visual_composer_extend" ) . '</div>';
														$output .= '<div class="toggle-blob" style="height: 18px;"></div>';
														$output .= '<div class="toggle-off active" style="height: 18px;">' . __( "Hide", "ts_visual_composer_extend" ) . '</div>';
													$output .= '</div>';
												$output .= '</div>';
											$output .= '</div>';
								...
								<tr>
									...
									<td style="padding-top: 20px;">
										<div id="ts-tiny-tinymce-iconanimation" class="toggle toggle-light" data-checkbox="ts-tiny-tinymce-iconanimation-check" style="width: 80px; height: 18px;" data-on="<?php _e( "Default", "ts_visual_composer_extend" ); ?>" data-off="<?php _e( "Hover", "ts_visual_composer_extend" ); ?>">
											<div class="toggle-slide">
												<div class="toggle-inner">
													<div class="toggle-on active" style="height: 18px;"><?php _e( "Default", "ts_visual_composer_extend" ); ?></div>
													<div class="toggle-blob" style="height: 18px;"></div>
													<div class="toggle-off" style="height: 18px;"><?php _e( "Hover", "ts_visual_composer_extend" ); ?></div>
												</div>
											</div>
										</div>
								...
								<tr>
									...
									<td style="padding-top: 20px;">
										<div id="ts-tiny-tinymce-icontooltip" class="toggle toggle-light" data-checkbox="ts-tiny-tinymce-icontooltip-check" style="width: 80px; height: 18px;" data-on="<?php _e( "Title", "ts_visual_composer_extend" ); ?>" data-off="<?php _e( "CSS3", "ts_visual_composer_extend" ); ?>">
											<div class="toggle-slide">
												<div class="toggle-inner">
													<div class="toggle-on active" style="height: 18px;"><?php _e( "Title", "ts_visual_composer_extend" ); ?></div>
													<div class="toggle-blob" style="height: 18px;"></div>
													<div class="toggle-off" style="height: 18px;"><?php _e( "CSS3", "ts_visual_composer_extend" ); ?></div>
												</div>
											</div>
										</div>
