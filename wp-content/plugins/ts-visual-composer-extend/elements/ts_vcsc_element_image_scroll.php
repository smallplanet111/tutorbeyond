<?php
    ...
    if (function_exists('vc_map')) {
        vc_map( array(
            ...
            "icon"                          	=> "icon-wpb-ts_vcsc_image_scroll",
            ...
            "params"                        	=> array(
                ...
                array(
                    ...
                    "step"                 	 	=> "1",
                    "unit"                  	=> 's',
                    "description"           	=> __( "Define the speed in seconds at which the image should be scroll down.", "ts_visual_composer_extend" ),
                ),
                array(
                    "type"                  	=> "nouislider",
                    ...
                    "step"                 	 	=> "1",
                    "unit"                  	=> 's',
                    "description"           	=> __( "Define the speed in seconds at which the image should be scroll back up.", "ts_visual_composer_extend" ),
                ),
				array(
					"type"             	 		=> "switch_button",
