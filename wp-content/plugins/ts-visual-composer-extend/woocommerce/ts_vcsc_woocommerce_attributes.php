<?php
    if (function_exists('vc_map')) {
		vc_map( array(
			"name" 							=> __("Products by Attribute", "ts_visual_composer_extend"),
			"base" 							=> "product_attribute",
			"icon" 							=> "icon-wpb-ts_vcsc_icon_commerce_attributes", 
			"class" 						=> "", 
			"category" 						=> __('VC WooCommerce', "ts_visual_composer_extend"),
            "description"					=> __("Place a list of products by attributes", "ts_visual_composer_extend"),
            "admin_enqueue_js"				=> "",
            "admin_enqueue_css"				=> "",
			"params" 						=> array(
				array(
					...
					"size"					=> "14",
					"value"					=> "",
					"message"            	=> __( "List products based on an attribute and one or more term filters.", "ts_visual_composer_extend" ),
					"description"       	=> __( "", "ts_visual_composer_extend" )
				),
				array(
					"type" 					=> "wc_product_attributes",
					"heading" 				=> __("Attribute", "ts_visual_composer_extend"),
					"param_name" 			=> "attribute",
					"admin_label"       	=> true,
					"description"       	=> __( "Select the attribute you want to utilize.", "ts_visual_composer_extend" ),
				),
				array(
					"type" 					=> "wc_product_terms",
					"heading" 				=> __("Filter", "ts_visual_composer_extend"),
					"param_name" 			=> "filter",
					"admin_label"       	=> true,
					"description"       	=> __( "Select the attribute term(s) you want to utilize.", "ts_visual_composer_extend" ),
				),
				array(
					"type"              	=> "nouislider",
