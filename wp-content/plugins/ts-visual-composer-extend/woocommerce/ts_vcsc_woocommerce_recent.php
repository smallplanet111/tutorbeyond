<?php
    if (function_exists('vc_map')) {
		vc_map( array(
			"name" 							=> __("Recent Products", "ts_visual_composer_extend"),
			"base" 							=> "recent_products",
			"icon" 							=> "icon-wpb-ts_vcsc_icon_commerce_recent", 
			"class" 						=> "", 
			"category" 						=> __('VC WooCommerce', "ts_visual_composer_extend"),
            "description"					=> __("Place a list of recent products", "ts_visual_composer_extend"),
            "admin_enqueue_js"				=> "",
            "admin_enqueue_css"				=> "",
			"params" => array(
				array(
					...
					"size"					=> "14",
					"value"					=> "",
					"message"            	=> __( "Lists a number of recent products; useful on the homepage.", "ts_visual_composer_extend" ),
