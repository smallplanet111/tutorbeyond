<?php
    if (function_exists('vc_map')) {
		vc_map( array(
			"name" 							=> __("Related Products", "ts_visual_composer_extend"),
			"base" 							=> "related_products",
			"icon" 							=> "icon-wpb-ts_vcsc_icon_commerce_related", 
			"class" 						=> "", 
			"category" 						=> __('VC WooCommerce', "ts_visual_composer_extend"),
            "description"					=> __("Place a list of related products", "ts_visual_composer_extend"),
            "admin_enqueue_js"				=> "",
            "admin_enqueue_css"				=> "",
			"params" 						=> array(
				array(
					...
					"size"					=> "14",
					"value"					=> "",
					"message"            	=> __( "Lists a number of products that are related to another product.", "ts_visual_composer_extend" ),
