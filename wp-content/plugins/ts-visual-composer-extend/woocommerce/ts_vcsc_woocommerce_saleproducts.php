<?php
    if (function_exists('vc_map')) {
		vc_map( array(
			"name" 							=> __("Products on Sale", "ts_visual_composer_extend"),
			"base" 							=> "sale_products",
			"icon" 							=> "icon-wpb-ts_vcsc_icon_commerce_saleproducts",
			"class" 						=> "", 
			"category" 						=> __('VC WooCommerce', "ts_visual_composer_extend"),
            "description"					=> __("Place a list of products on sale", "ts_visual_composer_extend"),
            "admin_enqueue_js"				=> "",
            "admin_enqueue_css"				=> "",
			"params" 						=> array(
				array(
					...
					"size"					=> "14",
					"value"					=> "",
					"message"            	=> __( "Lists all products currently on sale.", "ts_visual_composer_extend" ),
