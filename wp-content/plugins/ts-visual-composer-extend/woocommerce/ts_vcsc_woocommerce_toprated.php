<?php
    if (function_exists('vc_map')) {
		vc_map( array(
			"name" 							=> __("Top Rated Products", "ts_visual_composer_extend"),
			"base" 							=> "top_rated_products",
			"icon" 							=> "icon-wpb-ts_vcsc_icon_commerce_toprated", 
			"class" 						=> "", 
			"category" 						=> __('VC WooCommerce', "ts_visual_composer_extend"),
            "description"					=> __("Place a list of top rated products", "ts_visual_composer_extend"),
            "admin_enqueue_js"				=> "",
            "admin_enqueue_css"				=> "",
			"params" 						=> array(
				array(
					...
					"size"					=> "14",
					"value"					=> "",
					"message"            	=> __( "Lists the top rated products currently for sale.", "ts_visual_composer_extend" ),
