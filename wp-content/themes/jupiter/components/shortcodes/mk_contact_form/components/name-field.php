...
<div class="mk-form-row <?php echo $column_width; ?>">
	...
	<?php endif; ?>	
	<input placeholder="<?php _e( '名字', 'mk_framework' ); ?>" type="text" required="required" name="contact_name" class="text-input s_txt-input" value="" tabindex="<?php echo $view_params['tab_index']; ?>" />
</div>
